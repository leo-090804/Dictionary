...
//                }
//                List<String> searchResults = trie.searchPrefix(searchWord);
//                if (searchResults.isEmpty()) {
//                    performFuzzySearch(searchWord, trie);
//                } else {
...
//            } else {
//                try {
//                    List<String> searchResults = searchList(searchWord, allWordsOfflineSet);
//                    if (searchResults.isEmpty()) {
//                        performFuzzySearch(searchWord, allWordsOfflineSet);
//                    } else {
//                        listView.getItems().addAll(searchResults);
