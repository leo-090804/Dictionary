...
import Management.DictionaryGame;
...
//                    break;
                ...
                case 7:
                    while (choice != 3) {
                        ...
                        System.out.println("1. Chơi với từ nhập từ bàn phím");
                        System.out.println("2. Chơi với từ ngẫu nhiên từ file");
                        ...
                        switch (choice) {
                            case 1:
                                System.out.print("Nhập từ bạn muốn đoán: ");
                                String word = sc.nextLine();
                                DictionaryGame game1 = new DictionaryGame(word);
                                game1.play();
                                break;
                            case 2:
                                // Lấy ngẫu nhiên một từ từ file
                                String randomWord = DictionaryGame.getRandomWordFromFile();
                                if (randomWord != null) {
                                    DictionaryGame game2 = new DictionaryGame(randomWord);
                                    game2.play();
                                } else {
